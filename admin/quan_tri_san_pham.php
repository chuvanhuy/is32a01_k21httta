...
<body>
	<div style="width: 950px">
		...
		<div style="clear: both;">
			...
			<p><a href="../admin/quan_tri_san_pham_them_moi.php"><img src="../img/add.jpg" style="width: 32px; height: auto;"></a></p>
			<table>
				<tr>
					<td>STT</td>
					<td>Ảnh minh họa</td>
			...
			;?>
				...
				<tr>
					...
					<td><a href="../admin/quan_tri_san_pham_sua.php"><img src="../img/edit.png" style="width: 32px; height: auto;"></a> <a href="../admin/quan_tri_san_pham_xoa.php"><img src="../img/delete.png" style="width: 32px; height: auto;"></a></td>
				</tr>
